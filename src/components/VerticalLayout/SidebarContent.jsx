      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/administrator/clients" className="">
                <i className="bx bx-group"></i>
                <span>{props.t("Clients")}</span>
              </Link>
            </li>
            <li>
              <Link to="/administrator/doctors" className="">
            ...
            <li>
              <Link to="/administrator/appointments" className="">
            ...
            <li>
              <Link to="/doctor/clients" className="">
                <i className="bx bx-group"></i>
                <span>{props.t("Clients")}</span>
              </Link>
            </li>
            ...
            <li className="menu-title">{props.t("Client")}</li>
            <li>
