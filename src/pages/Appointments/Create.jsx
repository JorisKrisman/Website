...
const CreateAppointment = (props) => {
    ChangeTitle(props.t("Create Appointment"));
            ...
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs
                        ...
                        breadcrumbItem={props.t("Create Appointment")}
                    />

                    <Card>
                        <CardBody>
                            <CardTitle>{props.t("Create Appointment")}</CardTitle>
                            ...
                            <Form className="needs-validation" onSubmit={(e) => {
                                ...
                                <Row>
                                    <Col md="4">
                                        <FormGroup>
                                            <Label>{props.t("First Name Client")}</Label>
                                            <Input
                                                type="text"
                                                placeholder={props.t("First Name Client")}
                                    ...
                                    <Col md="4">
                                        <FormGroup>
                                            <Label>{props.t("Last Name Client")}</Label>
                                            <Input
                                                type="text"
                                                placeholder={props.t("Last Name Client")}
