...
const CreateDoctor = (props) => {
    ChangeTitle(props.t("Create Doctor"));
    ...
    const validation = useFormik({
        ...
        validationSchema: Yup.object({
            first_name: Yup.string().required(props.t("This field is required")), //
            prefix: Yup.string(), //
            last_name: Yup.string().required(props.t("This field is required")), //
            date_of_birth: Yup.date().required(props.t("This field is required")), //
            address: Yup.string().required(props.t("This field is required")),
            house_number: Yup.string().required(props.t("This field is required")),
            postal_code: Yup.string().required(props.t("This field is required")),
            city: Yup.string().required(props.t("This field is required")),
            country: Yup.string().required(props.t("This field is required")),
            phone_number: Yup.string().required(props.t("This field is required")), //
            phone_number_mobile: Yup.string().required(props.t("This field is required")), //
            email: Yup.string().required(props.t("This field is requried")), //
            citizenship_number: Yup.string().required(props.t("This field is required")), //
            insurance: Yup.string().required(props.t("This field is requried")), //
            insurance_number: Yup.string().required(props.t("This field is requried")), //
            gender: Yup.string().required(props.t("This field is requried")), //
        }),
        onChange: (values) => {
            console.log(values)
        },
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs
                        title={props.t("Create Doctor")}
                        breadcrumbItem={props.t("Create Doctor")}
                    />

                    <Card>
                        <CardBody>
                            <CardTitle>{props.t("Create Doctor")}</CardTitle>
...
export default withTranslation()(CreateDoctor);
