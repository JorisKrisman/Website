...
const ClientDetails = (props) => {
    ...
    ChangeTitle(props.t("Doctor Details"))
            ...
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs
                        ...
                        breadcrumbItem={props.t("Doctor Details")}
                    />
                    ...
                    <Row>
                        ...
                        <Card>
                            <CardBody>
                                <CardTitle>{props.t("Doctor Details")}</CardTitle>

                                <Table>
                                    <tbody>
                                        <tr>
                                            <th>{props.t("Role")}</th>
                                            <td>{props.t("Doctor")}</td>
                                        </tr>
                                        <tr>
                                            <th>{props.t("Name")}</th>
                                            <td>{client.name}</td>
                                ...
                                <a className={"btn btn-lg btn-rounded btn-primary"} href={`/administrator/doctors/${client.uuid}/edit`}>
                                    <i className="bx bx-pencil"></i>{props.t("Edit Doctor")}
                                </a>
